...
const PotItem: React.FC<IItem> = (props: IPotItemProps) => {
  ...
  switch (props.name) {
    case "fish":
      item = <img className="pot-item" src={PNGFish} alt={`${props.name}`} />;
      break;

    case "gold":
      item = <img className="pot-item" src={PNGGold} alt={`${props.name}`} />;
      break;

    case "badgold":
      item = (
        <img className="pot-item" src={PNGBadGold} alt={`${props.name}`} />
      );
      break;

    case "badfish":
      item = (
        <img className="pot-item" src={PNGBadFish} alt={`${props.name}`} />
      );
      break;
  }
  return <div>{item}</div>;
